...
@Component({
  selector: 'app-submittable-survey-list',
  imports: [
    Button,
    DataTableComponent,
    InputGroup,
  ...
  templateUrl: './submittable-survey-list.html',
  styleUrl: './submittable-survey-list.scss',
})
export class SubmittableSurveyList {
  cols = signal<any[]>([]);
  data = signal<any[]>([]);
  totalRecords = signal<number>(0);
  route = 'survey/survey-consumer/attend-survey'
